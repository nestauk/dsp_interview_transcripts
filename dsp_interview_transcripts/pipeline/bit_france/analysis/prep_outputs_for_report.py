...
if __name__ == "__main__":
    ...
    for profession in professions:
        ...
        repr_docs_final.to_csv(f"{DATA_PATH}/report/{profession}_repr_docs_final.csv", index=False)

        repr_docs_brief = repr_docs_final[
            ["Topic", "Name", "Keywords", "AI-generated name", "AI-generated description"]
        ].drop_duplicates()
        repr_docs_brief.to_csv(f"{DATA_PATH}/report/{profession}_repr_docs_brief.csv", index=False)
        ...
        ].to_csv(f"{DATA_PATH}/report/{profession}_full_data.csv", index=False)
